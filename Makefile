#############################################################################
# Makefile for building: neuron_detection_in_tiff
# Generated by qmake (3.0) (Qt 5.5.1)
# Project:  neuron_detection_in_tiff.pro
# Template: app
# Command: /Users/Evan/Qt/5.5/clang_64/bin/qmake -spec macx-clang CONFIG+=debug CONFIG+=x86_64 -o Makefile neuron_detection_in_tiff.pro
#############################################################################
...
INCPATH       = -I. -I/usr/local/include -I../../Qt/5.5/clang_64/mkspecs/macx-clang
QMAKE         = /Users/Evan/Qt/5.5/clang_64/bin/qmake
DEL_FILE      = rm -f
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = neuron_detection_in_tiff1.0.0
DISTDIR = /Users/Evan/Project/neuron_detection_in_tiff/.tmp/neuron_detection_in_tiff1.0.0
...
LIBS          = $(SUBLIBS) -L/usr/local/lib/ -ltiff 
...
DIST          = ../../Qt/5.5/clang_64/mkspecs/features/spec_pre.prf \
		...
		neuron_detection_in_tiff.pro tomo_tiff.h main.cpp \
		tomo_tiff.cpp
QMAKE_TARGET  = neuron_detection_in_tiff
DESTDIR       = #avoid trailing-slash linebreak
TARGET        = neuron_detection_in_tiff
...
Makefile: neuron_detection_in_tiff.pro ../../Qt/5.5/clang_64/mkspecs/macx-clang/qmake.conf ../../Qt/5.5/clang_64/mkspecs/features/spec_pre.prf \
		../../Qt/5.5/clang_64/mkspecs/qdevice.pri \
		../../Qt/5.5/clang_64/mkspecs/features/device_config.prf \
		../../Qt/5.5/clang_64/mkspecs/common/unix.conf \
		../../Qt/5.5/clang_64/mkspecs/common/mac.conf \
		...
		../../Qt/5.5/clang_64/mkspecs/features/yacc.prf \
		../../Qt/5.5/clang_64/mkspecs/features/lex.prf \
		neuron_detection_in_tiff.pro
	$(QMAKE) -spec macx-clang CONFIG+=debug CONFIG+=x86_64 -o Makefile neuron_detection_in_tiff.pro
...
tomo_tiff.o: tomo_tiff.cpp tomo_tiff.h \
		...
		/usr/local/include/tiffconf.h \
		/usr/local/include/tiffvers.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o tomo_tiff.o tomo_tiff.cpp
